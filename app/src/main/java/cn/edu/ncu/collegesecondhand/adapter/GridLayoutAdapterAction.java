 ...
 */
public class GridLayoutAdapterAction extends DelegateAdapter.Adapter<GridLayoutAdapterAction.GridViewHolder> {
    ...
    public GridLayoutAdapterAction(Context context, List<HeaderIcon> headerIcons, LayoutHelper helper, int count) {
    ...
    public GridViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new GridViewHolder(LayoutInflater.from(parent.getContext())
                .inflate(R.layout.header_action
                , parent, false));
    }
      ...
      //  private TextView textView;
       private LinearLayout layout;
        ...
        GridViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.header_action_image);
          ///  textView = itemView.findViewById(R.id.header_name);
            layout=itemView.findViewById(R.id.header_action_layout);
